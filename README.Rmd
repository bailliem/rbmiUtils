...
`rbmiUtils` extends the [rbmi](https://insightsengineering.github.io/rbmi/) pipeline from raw data to publication-ready outputs. Here is the complete workflow using the bundled `ADEFF` dataset:
